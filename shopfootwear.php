<html>
    <head>
        <title>Shopping - Shoester Malaysia</title>
        ...
        <?php
            ...
            $sql = "SELECT s.Sid, s.Sname, s.Sgender, s.Scategory, s.Sbrand, s.Spic, s.Sprice, s.Syear, sd.Sdid, sd.discount_percent, sd.discount_price
             From shoes s LEFT JOIN shoes_discount sd ON s.Sid = sd.Sid AND sd.valid_from <= '$currentTime'AND sd.valid_until > '$currentTime'";

                
            if($search !== null)
            $sql .= " WHERE Sname LIKE '%$search%' OR Scategory LIKE '%$search%' OR Sbrand LIKE '%$search%'";
            else
            {
            ...
            if($sorter=="latest") $sql.= " ORDER BY Sid DESC";
            else if($sorter=="name-a-z") $sql.= " ORDER BY Sname";
            else if($sorter=="name-z-a") $sql.= " ORDER BY Sname DESC";
            else if($sorter=="price-low-high") $sql.= " ORDER BY Sprice";
            else if($sorter=="price-high-low") $sql.= " ORDER BY Sprice DESC";
    ...
    <body>
        ...
        <div class="container">
            <div class="side">
                ...
                <script>
                    function filter(){
                        ...
                        window.location.href = "shopfootwear.php?gender="+checkedGenderValue+"&category="+checkedCategoryValue+"&brand="+checkedBrandValue;
            ...
            <div class="main">
                <?php
                if($search !== null){
                    echo" <h3 class='heading'>SEARCH RESULT - ".$search."</h3>";
                }
                
                else{
                    echo" <h3 class='heading'>SHOES - ".$gender." ".$category." ".$brand."</h3>";
                }
                ?>
                                        ...
                                        if($row["Sdid"]!==null){
                                            ...
                                            <div class='product'>
                                                ...
                                                <div class='product-info'>
                                                    ...
                                                    <p class='product-price'>RM".$row["Sprice"]."</p>
                                                </div>
                                            </div>
                                            <!-- end of single product -->
                                            ";
